"""
CS2 Aimbot - MAXIMUM PERFORMANCE
================================
Threaded capture + inference for maximum FPS.
...
SCREEN_WIDTH = 2560
SCREEN_HEIGHT = 1440
CAPTURE_SIZE = 640  # Smaller for speed (was 800)
    ...
    def _capture_loop(self):
        with mss.mss() as sct:
            while self.running:
                ...
                frame = np.array(screenshot)[:, :, :3]  # Drop alpha
...
def main():
    ...
    print("=" * 60)
    print("CS2 AIMBOT - MAXIMUM PERFORMANCE")
    print("=" * 60)
    ...
    try:
        while True:
            ...
            if frame_count >= 100:
                ...
                print(f"FPS: {fps:.0f} | Frame: {ms:.1f}ms | Inference: {INFERENCE_SIZE}px")
                frame_count = 0
                start_time = time.perf_counter()
